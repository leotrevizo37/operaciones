package com.duma.experience.api;
...
public class ExperienceController {
  ...
  public ExperienceController(ModuleProperties properties, ExperienceRepository repository) {
    this.properties = properties;
    this.repository = repository;
  }

  @GetMapping
  public ExperienceDashboard.Response dashboard(
    ...
    List<String> selected = selectTenants(tenant);
    List<ExperienceDashboard.TenantResult> results =
        selected.stream()
            .map(tenantId -> repository.load(tenantId, effectiveFrom, effectiveTo))
            .toList();
